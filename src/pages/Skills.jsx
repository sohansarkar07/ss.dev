...
const SKILLS = [
  ...
  { name: "Vercel", logo: "https://images.seeklogo.com/logo-png/39/2/vercel-logo-png_seeklogo-396226.png" },
...
const ROWS = [
  [
    ...
    { title: "Databases & Tools", items: [ "Git"] },
    { title: "Frameworks & Libraries", items: ["TensorFlow", "PyTorch", "OpenCV","Streamlit","Vercel","Flask"] },
  ],
  [
    {
      title: "Core Concepts",
